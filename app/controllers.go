...
func MountAccountsController(service *goa.Service, ctrl AccountsController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		if rawPayload := goa.ContextRequest(ctx).Payload; rawPayload != nil {
			rctx.Payload = rawPayload.(*AddAccountsPayload)
		} else {
	...
	service.Mux.Handle("POST", "/api/v1/accounts/", ctrl.MuxHandler("add", h, unmarshalAddAccountsPayload))
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the payload
		if rawPayload := goa.ContextRequest(ctx).Payload; rawPayload != nil {
			rctx.Payload = rawPayload.(*UpdateAccountsPayload)
		} else {
			return goa.MissingPayloadError()
		}
	...
	h = handleAccountsOrigin(h)
	service.Mux.Handle("PUT", "/api/v1/accounts/:id", ctrl.MuxHandler("update", h, unmarshalUpdateAccountsPayload))
...
type AccountsDataController interface {
	goa.Muxer
	Add(*AddAccountsDataContext) error
	Delete(*DeleteAccountsDataContext) error
	List(*ListAccountsDataContext) error
	Show(*ShowAccountsDataContext) error
	Update(*UpdateAccountsDataContext) error
}
...
func MountAccountsDataController(service *goa.Service, ctrl AccountsDataController) {
	initService(service)
	var h goa.Handler
	service.Mux.Handle("OPTIONS", "/api/v1/accounts_data/", ctrl.MuxHandler("preflight", handleAccountsDataOrigin(cors.HandlePreflight()), nil))
	service.Mux.Handle("OPTIONS", "/api/v1/accounts_data/:id", ctrl.MuxHandler("preflight", handleAccountsDataOrigin(cors.HandlePreflight()), nil))
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewAddAccountsDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
		if rawPayload := goa.ContextRequest(ctx).Payload; rawPayload != nil {
			rctx.Payload = rawPayload.(*AddAccountsDataPayload)
		} else {
			return goa.MissingPayloadError()
		}
		return ctrl.Add(rctx)
	}
	h = handleAccountsDataOrigin(h)
	service.Mux.Handle("POST", "/api/v1/accounts_data/", ctrl.MuxHandler("add", h, unmarshalAddAccountsDataPayload))
	service.LogInfo("mount", "ctrl", "AccountsData", "action", "Add", "route", "POST /api/v1/accounts_data/")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewDeleteAccountsDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Delete(rctx)
	...
	h = handleAccountsDataOrigin(h)
	service.Mux.Handle("DELETE", "/api/v1/accounts_data/:id", ctrl.MuxHandler("delete", h, nil))
	service.LogInfo("mount", "ctrl", "AccountsData", "action", "Delete", "route", "DELETE /api/v1/accounts_data/:id")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewListAccountsDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.List(rctx)
	...
	h = handleAccountsDataOrigin(h)
	service.Mux.Handle("GET", "/api/v1/accounts_data/", ctrl.MuxHandler("list", h, nil))
	service.LogInfo("mount", "ctrl", "AccountsData", "action", "List", "route", "GET /api/v1/accounts_data/")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewShowAccountsDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Show(rctx)
	...
	h = handleAccountsDataOrigin(h)
	service.Mux.Handle("GET", "/api/v1/accounts_data/:id", ctrl.MuxHandler("show", h, nil))
	service.LogInfo("mount", "ctrl", "AccountsData", "action", "Show", "route", "GET /api/v1/accounts_data/:id")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewUpdateAccountsDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
		if rawPayload := goa.ContextRequest(ctx).Payload; rawPayload != nil {
			rctx.Payload = rawPayload.(*UpdateAccountsDataPayload)
		} else {
			return goa.MissingPayloadError()
		}
		return ctrl.Update(rctx)
	...
	h = handleAccountsDataOrigin(h)
	service.Mux.Handle("PUT", "/api/v1/accounts_data/:id", ctrl.MuxHandler("update", h, unmarshalUpdateAccountsDataPayload))
	service.LogInfo("mount", "ctrl", "AccountsData", "action", "Update", "route", "PUT /api/v1/accounts_data/:id")
}

// handleAccountsDataOrigin applies the CORS response headers corresponding to the origin.
func handleAccountsDataOrigin(h goa.Handler) goa.Handler {
...
// unmarshalAddAccountsDataPayload unmarshals the request body into the context request data Payload field.
func unmarshalAddAccountsDataPayload(ctx context.Context, service *goa.Service, req *http.Request) error {
...
// unmarshalUpdateAccountsDataPayload unmarshals the request body into the context request data Payload field.
func unmarshalUpdateAccountsDataPayload(ctx context.Context, service *goa.Service, req *http.Request) error {
...
func MountBottlesController(service *goa.Service, ctrl BottlesController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the payload
		if rawPayload := goa.ContextRequest(ctx).Payload; rawPayload != nil {
			rctx.Payload = rawPayload.(*AddBottlesPayload)
		} else {
			return goa.MissingPayloadError()
		}
		return ctrl.Add(rctx)
	...
	service.Mux.Handle("POST", "/api/v1/bottles/", ctrl.MuxHandler("add", h, unmarshalAddBottlesPayload))
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the payload
		if rawPayload := goa.ContextRequest(ctx).Payload; rawPayload != nil {
			rctx.Payload = rawPayload.(*UpdateBottlesPayload)
		} else {
			return goa.MissingPayloadError()
		}
		return ctrl.Update(rctx)
	...
	h = handleBottlesOrigin(h)
	service.Mux.Handle("PUT", "/api/v1/bottles/:id", ctrl.MuxHandler("update", h, unmarshalUpdateBottlesPayload))
...
// unmarshalAddBottlesPayload unmarshals the request body into the context request data Payload field.
func unmarshalAddBottlesPayload(ctx context.Context, service *goa.Service, req *http.Request) error {
...
// unmarshalUpdateBottlesPayload unmarshals the request body into the context request data Payload field.
func unmarshalUpdateBottlesPayload(ctx context.Context, service *goa.Service, req *http.Request) error {
...
type BottlesDataController interface {
	goa.Muxer
	Add(*AddBottlesDataContext) error
	Delete(*DeleteBottlesDataContext) error
	List(*ListBottlesDataContext) error
	Show(*ShowBottlesDataContext) error
	Update(*UpdateBottlesDataContext) error
}
...
func MountBottlesDataController(service *goa.Service, ctrl BottlesDataController) {
	initService(service)
	var h goa.Handler
	service.Mux.Handle("OPTIONS", "/api/v1/bottles_data/", ctrl.MuxHandler("preflight", handleBottlesDataOrigin(cors.HandlePreflight()), nil))
	service.Mux.Handle("OPTIONS", "/api/v1/bottles_data/:id", ctrl.MuxHandler("preflight", handleBottlesDataOrigin(cors.HandlePreflight()), nil))
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewAddBottlesDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Add(rctx)
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewDeleteBottlesDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Delete(rctx)
	...
	h = handleBottlesDataOrigin(h)
	service.Mux.Handle("DELETE", "/api/v1/bottles_data/:id", ctrl.MuxHandler("delete", h, nil))
	service.LogInfo("mount", "ctrl", "BottlesData", "action", "Delete", "route", "DELETE /api/v1/bottles_data/:id")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewListBottlesDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.List(rctx)
	...
	h = handleBottlesDataOrigin(h)
	service.Mux.Handle("GET", "/api/v1/bottles_data/", ctrl.MuxHandler("list", h, nil))
	service.LogInfo("mount", "ctrl", "BottlesData", "action", "List", "route", "GET /api/v1/bottles_data/")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewShowBottlesDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Show(rctx)
	...
	h = handleBottlesDataOrigin(h)
	service.Mux.Handle("GET", "/api/v1/bottles_data/:id", ctrl.MuxHandler("show", h, nil))
	service.LogInfo("mount", "ctrl", "BottlesData", "action", "Show", "route", "GET /api/v1/bottles_data/:id")
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewUpdateBottlesDataContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Update(rctx)
...
// handleBottlesDataOrigin applies the CORS response headers corresponding to the origin.
func handleBottlesDataOrigin(h goa.Handler) goa.Handler {
