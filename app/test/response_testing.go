...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListResponseOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ResponseController) (http.ResponseWriter, app.UsertypeCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ListResponseOKTiny(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ResponseController) (http.ResponseWriter, app.UsertypeTinyCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
func NestedResponseOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ResponseController) (http.ResponseWriter, *app.Articletype) {
	...
	var mt *app.Articletype
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.Articletype)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.Articletype", resp)
		}
		_err = mt.Validate()
		if _err != nil {
			t.Errorf("invalid response media type: %s", _err)
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowResponseOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ResponseController, id string) (http.ResponseWriter, *app.Usertype) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.Usertype)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.Usertype", resp)
		}
		_err = mt.Validate()
		if _err != nil {
			t.Errorf("invalid response media type: %s", _err)
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowResponseOKTiny(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ResponseController, id string) (http.ResponseWriter, *app.UsertypeTiny) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt *app.UsertypeTiny
	if resp != nil {
		var ok bool
		mt, ok = resp.(*app.UsertypeTiny)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.UsertypeTiny", resp)
		}
		_err = mt.Validate()
		if _err != nil {
			t.Errorf("invalid response media type: %s", _err)
